...
namespace WebApplications.Infrastructure.Migrations
{
    ...
    [Migration("20260512123659_AddPurchaseInvoiceTables")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebApplications.Domain.Models.PurchaseInvoice", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("WebApplications.Domain.Models.PurchaseInvoiceItem", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("WebApplications.Domain.Models.ServiceReview", b =>
                {
                    ...
                    b.Property<long>("ServiceAppointmentId")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("WebApplications.Domain.Models.Vendor", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("WebApplications.Domain.Models.PurchaseInvoice", b =>
                {
                    b.HasOne("WebApplications.Domain.Models.Vendor", "Vendor")
                        .WithMany()
            ...
            modelBuilder.Entity("WebApplications.Domain.Models.PurchaseInvoiceItem", b =>
                {
                    ...
                    b.HasOne("WebApplications.Domain.Models.PurchaseInvoice", "PurchaseInvoice")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("WebApplications.Domain.Models.ServiceAppointment", b =>
                {
                    ...
                    b.HasOne("WebApplications.Domain.Models.Vehicle", "Vehicle")
                        .WithMany()
            ...
            modelBuilder.Entity("WebApplications.Domain.Models.ServiceReview", b =>
                {
                    ...
                    b.HasOne("WebApplications.Domain.Models.ServiceAppointment", "ServiceAppointment")
                        .WithMany("Reviews")
